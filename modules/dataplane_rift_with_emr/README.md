...
| <a name="input_additional_s3_read_access_bucket_arns"></a> [additional\_s3\_read\_access\_bucket\_arns](#input\_additional\_s3\_read\_access\_bucket\_arns) | (Optional) List of additional S3 bucket ARNs that the rift compute role should have read access to. The role will be granted GetObject, ListBucket, HeadObject, and HeadBucket permissions for these buckets. | `list(string)` | `[]` | no |
